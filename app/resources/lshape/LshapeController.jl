module LshapeController
  ...
  function pd2(a,b,n,m,node = 4)
    ...
    e = 4
    if node == 8
      r = Formula2d.Memb2d(Formula2d.Lshape2d(a, b, n, m),Formula2d.double_node)
    elseif node == 3
      e = 3
      r = Formula2d.Memb2d(Formula2d.Lshape2d(a, b, n, m),e)      
    elseif node == 6
      e = 3
      r = Formula2d.Memb2d(Formula2d.Lshape2d(a, b, n, m),Formula2d.double_node,e)      
    else
      r = Formula2d.Memb2d(Formula2d.Lshape2d(a, b, n, m))
    end    
    ...
    if e == 4
      for i in r.E
        ...
        push!(pd, aa) 
        #get i,j,k for display delaunay
        push!(ii,j[1]-1);push!(jj,j[2]-1);push!(kk,j[3]-1)
        push!(ii,j[1]-1);push!(jj,j[3]-1);push!(kk,j[4]-1)     
      end
    else
      for i in r.E
        j = i[[1:e;1]]
  ...
  @reactive mutable struct Model <: ReactiveModel
    ...
    #------
    data1::R{Vector{PlotData}} = pd2(2.0, 1.0, 10, 10)
