module RectController
  ...
  function pd2(a,b,n,m,node = 4)
    ...
    e = 4
    if node == 8
      r = Formula2d.Memb2d(Formula2d.Rectangle2d(a, b, n, m),Formula2d.double_node)
    elseif node == 3
      e = 3
      r = Formula2d.Memb2d(Formula2d.Rectangle2d(a, b, n, m),e)      
    elseif node == 6
      e = 3
      r = Formula2d.Memb2d(Formula2d.Rectangle2d(a, b, n, m),Formula2d.double_node,e)      
    else
      r = Formula2d.Memb2d(Formula2d.Rectangle2d(a, b, n, m))
    end
    #=
    if node == 4
