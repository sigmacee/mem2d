module SectorController
  ...
  function pd2(a,b,n,node = 3)
    ...
    ii, jj, kk =[], [], []
    if node == 3
      r = Formula2d.Memb2d(Formula2d.Sector2d(a, b, n))    
    else
      r = Formula2d.Memb2d(Formula2d.Sector2d(a, b, n),Formula2d.double_node)
    end
  ...
  @reactive mutable struct Model <: ReactiveModel
    ...
    #------
    data1::R{Vector{PlotData}} = pd2(1.0, 90, 10)
...
function base()
  ...
  onbutton(model.bmesh) do
    ...
    a, b, n = model.A[], model.B[], model.NA[]
    dd = pd2(a,b,n,node)
    model.data1[] = dd
