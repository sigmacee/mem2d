module TriController
  ...
  function pd2(a,b,n,m,node = 3)
    ...
    #ii, jj, kk =[], [], []
    if node == 3
      r = Formula2d.Memb2d(Formula2d.Triangle2d(a, b, n, m))    
    else
      r = Formula2d.Memb2d(Formula2d.Triangle2d(a, b, n, m),Formula2d.double_node)
    end
